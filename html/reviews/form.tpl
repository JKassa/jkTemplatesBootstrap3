<form class="form-horizontal" id="reviewForm">
    ...
    <div class="form-group">
        <label class="control-label col-sm-4" for="reviewDignity">
    ...
    <div class="form-group">
        <label class="control-label col-sm-4" for="reviewShortcomings">
    ...
    <div class="form-group">
        <label class="control-label col-sm-4" for="reviewReview">
    ...
    <div class="form-group">
        <label class="control-label col-sm-4" for="reviewName">
    ...
    <div class="form-group">
        <label class="control-label col-sm-4" for="reviewEmail">
    ...
    <div class="form-group">
        <div class="col-sm-offset-4 col-sm-8">
            <a href="#" class="btn btn-default" data-click="send-review">
