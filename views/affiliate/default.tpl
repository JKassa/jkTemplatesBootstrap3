...
{{ 'startAccordion' | bootstrap3: 'affiliateAccordian' }}
{% if aff_items %}
<!--Transactions-->
{{ 'addSlide' | bootstrap3: 'affiliateAccordian', 'COM_JKASSA_AFFILIATE_TRANSACTIONS', 'transactions' }}
...
{% if user_cash %}
<!--Withdrawal of funds-->
{{ 'addSlide' | bootstrap3: 'affiliateAccordian', 'COM_JKASSA_AFFILIATE_WITHDRAWAL', 'withdrawal' }}
<p>
...
{% if pay_items %}
<!--Payments-->
{{ 'addSlide' | bootstrap3: 'affiliateAccordian', 'COM_JKASSA_AFFILIATE_PAYMENTS', 'payments' }}
<table class="table table-striped">
	<thead>
		<tr>
			<th>{{ '_' | jtext: 'JDATE' }}</th>
...
{% if banners %}
<!--Banners-->
{{ 'addSlide' | bootstrap3: 'affiliateAccordian', 'COM_JKASSA_AFFILIATE_BANNERS', 'banners' }}
